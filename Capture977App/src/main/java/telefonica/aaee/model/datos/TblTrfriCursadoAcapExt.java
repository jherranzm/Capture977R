...
/**
 * The persistent class for the tbl_trfri_cursado_acap_ext database table.
 * 
 */
@Entity
@Table(name="tbl_trfri_cursado_acap_ext")
@XmlRootElement
public class TblTrfriCursadoAcapExt 
