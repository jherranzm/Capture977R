...
/**
 * The persistent class for the tbl_trfint_cursado_acap_ext database table.
 * 
 */
@Entity
@Table(name="tbl_trfint_cursado_acap_ext")
@XmlRootElement
public class TblTrfintCursadoAcapExt 
    ...
    public TblTrfintCursadoAcapExt() {
    }
